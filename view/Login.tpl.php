...
<div class="row">
    <div class="col-md-4">
        <img class="profile-img" width="100%" height="100%"
             src="http://www.serwer1309029.home.pl/gt/public_html/juniperus/wp-content/uploads/2013/09/kominek-w-ogrodzie12.jpg"/>
    </div>
    <div class="col-md-4">
        ...
        <div class="account-wall">
            ...
            <form class="form-signin" id="register-form" method="post">
                ...
                <input type="password" class="form-control" id="haslo2" name="haslo2" placeholder="Powtórz hasło:"
                       required autofocus>
                <p></p>
                <button class="btn btn-lg btn-primary btn-block" id="submitButton" type="submit">Zarejestruj się
                </button>
