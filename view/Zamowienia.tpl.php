                ...
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tr class="even pointer table table-striped jambo_table">
                            ...
                            <td class=" "><?= $row['imie']; ?></td>
                            <td class=" "><?= $row['nazwisko']; ?></td>
                            <td class=" ">
                                <select class="form-control" style="width: 100px;"
                                        id=<?php echo $row['id_zamowienia'] ?>>
                                    <?php if ($row['status_zamowienia'] === 'paid') { ?>
                                        <option>paid</option>
                            ...
                            <td class="a-right a-right "><?= $row['suma']; ?> (zł)</td>
                            <td class=" last"><a href="index.php?do=faktura&id=<?= $row['id_zamowienia']; ?>">Wygeneruj
                                    fakturę</a>
                            </td>
                        </tr>
                        <?php } ?>
    ...
    var main = function () {
        $(".form-control").change(function () {
            ...
            $("select#" + id + " option:selected").each(function () {
                var dataString = 'id='+id+'&status='+$(this).text();
                $.ajax({
                    type: "POST",
                    url: "zamowienia.php",
                    data: dataString,
