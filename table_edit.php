...
if($input['typ'] === 'produkty')
{
    if ($input['action'] === 'edit') {
        $sql = "UPDATE produkt set nazwa_produktu='" . $input['nazwa_produktu'] . "', opis_produktu='" . $input['opis_produktu'] . "', id_kategorii='" . $input['id_kategorii'] . "', cena_jednostkowa='" . $input['cena_jednostkowa'] . "', image='" . $input['image'] . "' WHERE id_produktu='" . $input['id_produktu'] . "'";
